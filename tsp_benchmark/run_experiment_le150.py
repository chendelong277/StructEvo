...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the TSP benchmark only on instances with dimension <= 150.")
    parser.add_argument("--config", default="config/default_experiment.json", help="Path to the JSON experiment config.")
    parser.add_argument("--label", default="benchmark_le150", help="Experiment label.")
